 ...
 */
export function CaptionModal({ isOpen, onClose, caption, onRegenerate, onCopy, isGenerating }: CaptionModalProps) {
    ...
    <BlurOverlay onClick={onClose}>
      ...
      >
        <CardContent className="p-6">
          ...
          <div id="caption-modal-description" className="bg-muted/50 rounded-xl p-6 mb-6 shadow-inner">
